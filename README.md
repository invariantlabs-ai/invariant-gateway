...
This enables you to _observe, debug and scan for security issues_ in your agents, using the [Invariant Stack for secure and reliable agents](https://github.com/invariantlabs-ai/invariant).
